 ...
 */
class SLIGO_W :public WAREHOUSE {
public:
    /*!
     * Constructor
     */
    SLIGO_W() : WAREHOUSE(){
        ...
        this->_shop_address = "Sligo River Street";
        this->_shop_name = "SLIGO S_WAREHOUSE";
     ...
     * Custom constructor
     */
    SLIGO_W(std::string address, std::string shop_name, int iphone, int samsung, int sony, int huawei, int nokia, int alcatel): WAREHOUSE(){
        /*
         * copy over values
         */
     ...
     */
    SLIGO_W(std::shared_ptr<WAREHOUSE> obj, int _version, int _unique_id): WAREHOUSE(_version, _unique_id){
        /*
         * copy over values
         */
     ...
     */
   // virtual std::shared_ptr<SLIGO_W> _cast(std::shared_ptr<OSTM> _object);
