...
/**
 * \brief Test with a vector collection
 * @param _customer_vec collection of OSTM type objects
 * @param _tm TRansaction Manager
 * @param _amount value used in the transaction
 */
...
/**
 * \brief one object in the trasaction
 * @param _to_ pointer used in transaction
 * @param _tm TRansaction Manager
 * @param _amount value used in the transaction
 */
...
/**
 * \brief This function use two single objects and a collection of objects in the transaction.
 * The two single object transfer 1 - 1 (2) unit to every object in the collection
 * @param _from_ pointer used in transaction
 * @param _from_two_ pointer used in transaction
 * @param _customer_vec collection of pointer
 * @param _tm TRansaction Manager
 * @param _amount value used in the transaction
 */
...
/**
 * \brief Testing the transactions between six object
 * @param _to_ pointer used in transaction 
 * @param _from_one_ pointer used in transaction
 * @param _from_two_ pointer used in transaction
 * @param _from_three_ pointer used in transaction
 * @param _from_four_ pointer used in transaction
 * @param _from_five_ pointer used in transaction
 * @param _tm Transaction Manager
 * @param _amount value used in the transaction
 */
...
/**
 * \brief Testin transaction between two pointer
 * @param _to_ pointer used in transaction
 * @param _from_ pointer used in transaction
...
/**
 * \brief Testing nested transaction
 * @param _to_ pointer used in transaction
 * @param _from_ pointer used in transaction
 * @param _tm Transaction Manager
 * @param _amount value used in the transaction
...
/**
 * \ brief Testing the library consistent behavior   
...
/**
 * \brief This function proves the objects states must change from the base values.
 */
...
/*
 * \brief The library function throws runtime error if the client application tries to 
...
/**
 * \brief The test function throws runtime error if the client application tries to 
...
/**
 * \brief Testing the nesting increase function. 
 */
...
/**
 * \brief Testing the nesting decrease function. 
 */
...
/**
 * \brief Testing the nesting increase function to make sure the variable state changing. 
 */
...
/**
 * \brief Testing the nesting decrease function to make sure the variable state changing. 
 */
...
/**
 * \brief This testing function comparing the Transaction Manager to make sure the application using a Singleton object.
 */
...
/**
 * \brief This function testing the returned map from the Transaction Manager class. 
 */
...
/**
 * \brief  Design Manual document based tests Implementations
...
/**
 *  \brief  1. Single thread multiple transactional object exchange test
 */
...
/**
 * \brief 2. Multi-threaded single Object test with 10 threads.
 */
...
/**
 * \brief 3. Single-threaded multiple object test.
 */
...
/**
 * \brief  4. Multi-threaded multiple Objects test.
 */
