 ...
 */
class CARLOW_W :public WAREHOUSE {
public:
    /*!
     * Constructor
     */
    CARLOW_W() : WAREHOUSE(){
        ...
        this->_shop_address = "Carlow potato street";
        this->_shop_name = "CARLOW C_WAREHOUSE";
     ...
     * Custom constructor
     */
    CARLOW_W(std::string address, std::string shop_name, int iphone, int samsung, int sony, int huawei, int nokia, int alcatel): WAREHOUSE(){
        /*
         * copy over values
         */
     ...
     */
    CARLOW_W(std::shared_ptr<WAREHOUSE> obj, int _version, int _unique_id): WAREHOUSE(_version, _unique_id){
        /*
         * copy over values
         */
     ...
     */
   // virtual std::shared_ptr<CARLOW_W> _cast(std::shared_ptr<OSTM> _object);
