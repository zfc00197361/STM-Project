 ...
 *
 * \subsection install_sec Brief. Download the zip file from the provided (Windows, Linux, MAC OSX)link in the web-site, 
 ...
 * 
 * \subsection step5 Step 5: Create an executable file as you linking together the library, the *.h files with your own files. 
 * 
