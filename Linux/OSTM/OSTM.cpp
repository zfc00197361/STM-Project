 ...
 * \param _version_number_  Integer value used to create a copy of the object with the actual version
 * \param _unique_id_ Integer value used to create a copy of the object with the original unique ID
 */
