 ...
 */
class TALLAGH_W :public WAREHOUSE {
public:
    /*!
     * Constructor
     */
    TALLAGH_W() : WAREHOUSE(){
        ...
        this->_shop_address = "Tallagh Low street";
        this->_shop_name = "TALLAGH T_WAREHOUSE";
     ...
     * Custom constructor
     */
    TALLAGH_W(std::string address, std::string shop_name, int iphone, int samsung, int sony, int huawei, int nokia, int alcatel): WAREHOUSE(){
        /*
         * copy over values
         */
     ...
     */
    TALLAGH_W(std::shared_ptr<WAREHOUSE> obj, int _version, int _unique_id): WAREHOUSE(_version, _unique_id){
        /*
         * copy over values
         */
     ...
     */
    //virtual std::shared_ptr<TALLAGH_W> _cast(std::shared_ptr<OSTM> _object);
