...
KILKENNY_W::~KILKENNY_W() {
}

KILKENNY_W::KILKENNY_W(const KILKENNY_W& orig) {
}
/*!
 ...
 */
std::shared_ptr<OSTM> KILKENNY_W::getBaseCopy(std::shared_ptr<OSTM> object)
{

    std::shared_ptr<WAREHOUSE> objTO = std::dynamic_pointer_cast<WAREHOUSE>(object);
    std::shared_ptr<WAREHOUSE> obj(new KILKENNY_W(objTO, object->Get_Version(),object->Get_Unique_ID()));
 ...
 */
void KILKENNY_W::copy(std::shared_ptr<OSTM> to, std::shared_ptr<OSTM> from){

    std::shared_ptr<KILKENNY_W> objTO = std::dynamic_pointer_cast<KILKENNY_W>(to);
    std::shared_ptr<KILKENNY_W> objFROM = std::dynamic_pointer_cast<KILKENNY_W>(from);
 ...
 */
//std::shared_ptr<KILKENNY_W> KILKENNY_W::_cast(std::shared_ptr<OSTM> _object){
//    
//    return static_cast<std::shared_ptr<KILKENNY_W>>(_object);
//}
/*!
 *  \brief toString function, displays the object values in formatted way
 */
void KILKENNY_W::toString()
{
...
void KILKENNY_W::SetNumber_of_alcatel(int _number_of_alcatel) {
    this->_number_of_alcatel = _number_of_alcatel;
}

int KILKENNY_W::GetNumber_of_alcatel(){
    return _number_of_alcatel;
}

void KILKENNY_W::SetNumber_of_nokia(int _number_of_nokia) {
    this->_number_of_nokia = _number_of_nokia;
}

int KILKENNY_W::GetNumber_of_nokia(){
    return _number_of_nokia;
}

void KILKENNY_W::SetNumber_of_huawei(int _number_of_huawei) {
    this->_number_of_huawei = _number_of_huawei;
}

int KILKENNY_W::GetNumber_of_huawei(){
    return _number_of_huawei;
}

void KILKENNY_W::SetNumber_of_sony(int _number_of_sony) {
    this->_number_of_sony = _number_of_sony;
}

int KILKENNY_W::GetNumber_of_sony(){
    return _number_of_sony;
}

void KILKENNY_W::SetNumber_of_samsung(int _number_of_samsung) {
    this->_number_of_samsung = _number_of_samsung;
}

int KILKENNY_W::GetNumber_of_samsung(){
    return _number_of_samsung;
}

void KILKENNY_W::SetNumber_of_iphones(int _number_of_iphones) {
    this->_number_of_iphones = _number_of_iphones;
}

int KILKENNY_W::GetNumber_of_iphones(){
    return _number_of_iphones;
}

void KILKENNY_W::SetShop_name(std::string _shop_name) {
    this->_shop_name = _shop_name;
}

std::string KILKENNY_W::GetShop_name(){
    return _shop_name;
}

void KILKENNY_W::SetShop_address(std::string _shop_address) {
    this->_shop_address = _shop_address;
}

std::string KILKENNY_W::GetShop_address(){
