...
public:
     ...
     */
	__declspec(dllexport) void _register(std::shared_ptr<OSTM>  object);
    /*!
     * Register OSTM pointer into STM library 
     */
	__declspec(dllexport) std::shared_ptr<OSTM>  load(std::shared_ptr<OSTM>  object);
    /*!
     * \brief Store transactional changes
     */
	__declspec(dllexport) void store(std::shared_ptr<OSTM>  object);
    /*!
     * \brief Commit transactional changes
     */
	__declspec(dllexport) bool commit();
    /*!
     ...
     */
	__declspec(dllexport) int getTest_counter();
    /*!
     ...
     * TESTING ONLY
     */
	__declspec(dllexport) void _print_all_tx() ;
